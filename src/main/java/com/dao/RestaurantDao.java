...
public class RestaurantDao {
	...
	public List<RestaurantEntity> getRestaurantByActive(Integer active){
		...
		Query restaurants=	session.createQuery("from RestaurantEntity r where r.active=:active",RestaurantEntity.class);
	...
	public List<RestaurantEntity> getRestaurantByActiveAndPincode(Integer active,Integer pincode){
		Session session=sf.openSession();
		Query restaurants=	session.createQuery("from RestaurantEntity r where r.active =: active and r.pincode =: pincode",RestaurantEntity.class);
		restaurants.setParameter("active", active);
